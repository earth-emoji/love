...
class EventForm(forms.ModelForm):
    ...
    start_time = forms.DateTimeField(input_formats=['%m/%d/%y %H:%M',], widget=forms.DateTimeInput(attrs={}, format='%m/%d/%y %H:%M'))
    end_time = forms.DateTimeField(input_formats=['%m/%d/%y %H:%M',], widget=forms.DateTimeInput(attrs={}, format='%m/%d/%y %H:%M'))
